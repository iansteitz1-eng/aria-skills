...
aria-skills is published by InsyncTech.

## Reporting a vulnerability

Email support@insynctech.io. Put "aria-skills security" in the subject line. Do not open a public
issue for a security problem.

Include what you can:

- the version (the git commit or tag you are on)
- steps to reproduce
