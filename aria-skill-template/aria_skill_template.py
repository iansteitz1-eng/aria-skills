...
- **[Vox Ordo](https://voxordo.io)** — hosted version with audit trail + scheduled runs + team approval
...
[Vox Ordo](https://voxordo.io) layers approval workflow + audit trail + scheduled runs.
...
- Manifest pattern doc: `skill-manifest-gen/README.md` in this repo
