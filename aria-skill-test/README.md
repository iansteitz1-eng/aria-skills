...
# ═══════════════════════════════════════════════════════════════════════
#   ✓  github-repo-deploy                1234ms
#   ✓  cloudflare-dns-deploy             892ms
#   ✓  surgical-patch                    1102ms
#   ...
#   All tests passed.
```
...
# Test one skill:
python3 aria_skill_test.py --skill github-repo-deploy
...
- **[Vox Ordo](https://voxordo.io)** — hosted version with continuous regression monitoring
