...
Same shape as [`stripe-sync`](../stripe-sync/) and [`cloudflare-dns-deploy`](../cloudflare-dns-deploy/). See [BUILDER_GUIDE.md](../BUILDER_GUIDE.md) for the YAML-reconcile + two-flag-prod pattern.
